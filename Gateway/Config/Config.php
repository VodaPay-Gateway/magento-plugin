...
namespace VodaPay\VodaPay\Gateway\Config;

use Magento\Framework\App\Config\ScopeConfigInterface;
use VodaPay\VodaPay\Model\CoreFactory;

/**
 * VodaPay config class to define the plugin's abilities
 *
 * Class Config
 */
class Config extends \Magento\Payment\Gateway\Config\Config
{
    ...
    public const PAYMENT_ACTION          = 'vodapay_payment_action';
    ...
    public const INITIAL_ORDER_STATUS    = 'vodapay_initial_order_status';
    ...
    /**
     * Gets VodaPay Refund Status
     *
     * @param int|null $storeId
     *
     * @return bool|null
     */
    public function getIsVodaPayRefundStatus(int $storeId = null): ?bool
    {
